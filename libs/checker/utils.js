...
module.exports = (s,config,lang) => {
    ...
    function canAddMoreMonitors() {
        const cameraCountChecks = [
            { kind: 'ec2', maxCameras: 500, condition: config.isEC2 },
            { kind: 'highCoreCount', maxCameras: 500, condition: config.isHighCoreCount },
            { kind: 'default', maxCameras: 500, condition: true },
        ];
